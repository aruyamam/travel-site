...
var MobileMenu = function () {
  ...
  _createClass(MobileMenu, [{
    ...
    value: function toggleTheMenu() {
      ...
      this.menuIcon.toggleClass('site-header__menu-icon--is-close-x');
    }
  }]);
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.siteHeader = (0, _jquery2.default)('.site-header');
    this.headerTriggerrElement = (0, _jquery2.default)('.large-hero__title');
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      var that = this;
      new Waypoint({
        element: this.headerTriggerrElement[0],
    ...
    value: function createPageSectionWaypoints() {
      ...
      this.pageSections.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == 'down') {
              var matchingHeaderLnk = currentPageSection.getAttribute('data-matching-link');
              that.headerLinks.removeClass('is-current-link');
              (0, _jquery2.default)(matchingHeaderLnk).addClass('is-current-link');
            }
          },
          offset: '18%'
        });
